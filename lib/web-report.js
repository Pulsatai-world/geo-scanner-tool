...
export function buildWebStyleHtml(result, repoRoot, lang = 'es') {
  ...
  const boot = `
<script>
  // Fix the language for this rendered copy; the payload still carries both.
  try { LANG = ${JSON.stringify(lang)}; } catch (e) {}
